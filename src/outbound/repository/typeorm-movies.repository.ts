...
export class TypeORMMoviesRepository
    extends BaseRepository<TypeORMMoviesEntity>
{
    async saveMovies(params:MoviesRepository.Params): Promise<MoviesRepository.Result> {
